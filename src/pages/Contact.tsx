        ...
        <div className="grid lg:grid-cols-2 gap-12">
          ...
          <div className="rounded-2xl bg-card p-8 animate-slide-up stagger-2">
            ...
            <div className="grid grid-cols-2 gap-4">
              {/* Telegram */}
              <a
                href="https://t.me/kingdomworkforce"
                target="_blank"
              ...
              <a
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-2xl border border-border hover:border-primary/50 hover:bg-muted/60 transition-all hover:scale-105"
              >
                <div className="w-16 h-16 rounded-full bg-[hsl(220,46%,48%)] flex items-center justify-center text-white group-hover:scale-110 transition-transform">
              ...
              <a
                ...
                className="group flex flex-col items-center gap-3 p-6 rounded-2xl border border-border hover:border-primary/50 hover:bg-muted/60 transition-all hover:scale-105"
              >
                <div className="w-16 h-16 rounded-full bg-gradient-to-br from-[hsl(37,97%,60%)] via-[hsl(340,75%,55%)] to-[hsl(280,70%,55%)] flex items-center justify-center text-white group-hover:scale-110 transition-transform">
              ...
              <div className="space-y-4 text-sm">
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Reach out via any of our social channels or call us directly. We'll match you with the right team for your project.
                  </p>
                </div>
                <div>
