...
const Terms = () => {
  return (
    <div className="min-h-screen bg-background animate-fade-in">
      <SEO title="Terms of Service — Deldey Finishing Specialist" description="Terms of service for Deldey Finishing Specialist's website and services." path="/terms" />
      <Header />
        ...
        <div className="prose prose-lg max-w-none space-y-8">
          ...
          <section>
            ...
            <p className="text-muted-foreground">
              ...
              Deldey Finishing Specialist and is protected by international copyright laws.
            </p>
          </section>
